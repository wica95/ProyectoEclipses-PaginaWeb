...
obtenerJson = fetch('./assets/data/sabias-que.json').then(function(resp) {
    return resp.json();
})
.then(function(data){ 
    ...
    document.getElementById('detalle-bibliografia1').innerHTML = data[i].bibliografia1;
    document.getElementById('detalle-bibliografia2').innerHTML = data[i].bibliografia2;
